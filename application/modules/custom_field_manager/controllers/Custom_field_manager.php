...
Modules:
{
   "292":{
      ...
      "limit_enabled":"1",
      "extra_text":"month",
      "module_name":"Bot - User Input Flow Campaign"
   }
}
Project ID: 49
...
class Custom_field_manager extends Home
{
  ...
  public function __construct()
  {
    ...
    if($this->basic->is_exist("add_ons",array("project_id"=>49))) check_module_access($module_id=292);
  ...
  {
    $this->ajax_check();
    check_module_action_access($module_id=292,$actions=1);
  ...
  {
    $this->ajax_check();
    check_module_action_access($module_id=292,$actions=2);
  ...
  {
    $this->ajax_check();
    check_module_action_access($module_id=292,$actions=3);
  ...
  public function get_customfield_on_replytype()
  {
    ...
    $media_type = $this->input->post('media_type',true);
    $custom_fileds_content = '';
    $custom_field_list = $this->basic->get_data('user_input_custom_fields',['where'=>['reply_type'=>$reply_type,'media_type'=>$media_type,'user_id'=>$this->user_id]]);
  ...
  public function export_flow_data() 
  {
    ...
    if(!check_module_action_access($module_id=292,$actions=4,'check')){
