...
<section class="section section_custom">
    <div class="section-header">
        ...
        <div class="section-header-button">
            <a class="btn btn-primary" id="add_feed" data-toggle="modal" href='#add_feed_modal'><i class="fas fa-plus-circle"></i> <?php echo $this->lang->line('Add new wordpress blog');?></a>
        </div>
...
<script type="text/javascript">
    $("document").ready(function(){
      ...
      $(document).on('click','#add_feed_submit',function(){ 
        ...
        {
          swal('<?php echo $this->lang->line("Error"); ?>', "<?php echo $this->lang->line('Wordpress blog URL can not be empty');?>" , 'error');
          return;
        }
...
<div class="modal fade" id="add_feed_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fab fa-wordpress"></i> <?php echo $this->lang->line("Wordpress post auto-posting") ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <form action="#" id="add_feed_form">
                <div class="modal-body">
                    ...
                    <?php echo form_dropdown('wordpress_blog_url', $wordpress_blogs, null, 'class="form-control select2"'); ?>
                    <div class="space"></div>
                    <div class="space"></div>
                </div>
