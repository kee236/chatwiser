...
<section class="section ">
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			...
			<div class="breadcrumb-item"><?php echo $this->lang->line("Add Plugin"); ?></div>
		</div>
	</div>
				                       	 ...
				                       	 <div class="reminder_badge_warpper tab-pane fade" id="msg_checkout" role="tabpanel" aria-labelledby="msg_checkout_link>">
					                         ...
					                         <div class="reminder_block">
					                         	...
					                         	<span class="block4">
					                         		...
					                         		<p>
					                         		<input data-toggle="tooltip" title="<?php echo $this->lang->line('Website link will be embedded here, click to edit button name. Clean text if you do not want this.'); ?>" value="Visit Shop" class="btn btn-block bg-white" name="msg_checkout_btn_website" id="msg_checkout_btn_website"/>
					                         		</p>
					                         	</span>
					                         </div>
					                     </div>
					                 	 ...
					                 	 for($i=1; $i <=$how_many_reminder; $i++)
				                       	 { ?>
					                         <div class="reminder_badge_warpper tab-pane fade <?php if($i==1) echo 'active show';?>" id="sms_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="sms_reminder_link>">
						                         ...
						                         <div class="reminder_block">
						                         	<span class="block4">
						                         		<textarea data-toggle="tooltip" title="<?php echo $this->lang->line('SMS content goes here.');?>" name="sms_reminder_text_checkout[]" id="sms_reminder_text_checkout<?php echo $i;?>">Hi, have you forgot something special? Stock limited, complete your order before it is out of stock : {{cart_url}}</textarea>
						                         	</span>
						                         </div>
						                     </div>
					                     <?php 
							           	 ...
							           	 for($i=1; $i <=$how_many_reminder; $i++)
							             	 { ?>
							                   <div class="reminder_badge_warpper tab-pane fade <?php if($i==1) echo 'active show';?> " style="border:none;padding: 0" id="email_reminder<?php echo $i;?>" role="tabpanel" aria-labelledby="email_reminder_link>">
							                       ...
							                       <textarea class="visualeditor" data-toggle="tooltip" title="<?php echo $this->lang->line('Email content goes here.');?>" name="email_reminder_text_checkout[]" id="email_reminder_text_checkout<?php echo $i;?>">Hi {{last_name}},<br>Have you forgot something special? Stock limited, complete your order before it is out of stock : <a href="{{checkout_url}}" target="_blank">Checkout here</a></a><br>Happy shopping :)</textarea>							                       	
							                   </div>
							               	 <?php 
							             	 } 
							             	 ?>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-footer">  
							<button class="btn btn-lg btn-primary" id="get_button" name="get_button" type="button"><i class="fas fa-code"></i> <?php echo $this->lang->line("Generate Plugin");?></button>
		...
		{        
			...
			$.ajax({
				...
				{  
					...
					{	
						swal('<?php echo $this->lang->line("Plugin Created"); ?>', response.message, 'success').then((value) => {$('.download').attr('campaign_id',response.id).click();});
