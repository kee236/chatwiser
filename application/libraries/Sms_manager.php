...
class Sms_manager{
	...
	****/
    ...
    try {
        ...
        $message_info = array(
            'id' => isset($response['SMSMessageData']['Recipients'][0]['messageId']) ? $response['SMSMessageData']['Recipients'][0]['messageId'] : "",
            'status' => isset($response['SMSMessageData']['Recipients'][0]['status']) ? $response['SMSMessageData']['Recipients'][0]['status'] : 'unknown'
        );
        ...
        $message_info = array(
            'id' => "",
            'status' => 'error in config: ' . $e->getMessage()
        );
