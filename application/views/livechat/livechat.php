            ...
            <div class="row main_row">
              <div class="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-3 pe-xl-0 p-0 border-left" id="col-subscriber-list">
                <div class="card card-success no_radius mb-1 border-0">
                  ...
                  <div class="card-header p-0 bg-whatsapp d-flex flex-column no_radius" id="livechat_menu" style="<?php echo $backgroundStyle; ?>">
                        ...
                        <div class="row">
                            <div class="col-12 ps-0 pe-0">
                                <div class="input-group">
                                    <div class="d-flex" id="chat_options_left">
                            ...
                            <div class="col-12 d-none">
                                <div class="d-flex justify-content-center" id="chat_options_bottom" style="margin-top:10px;">
                                </div>
                            </div>
                       </div>
                      </form>
...
<script>
    $(document).ready(function(){
        ...
        if($(window).width()<=600)
        {
            ...
            let livechat_menu_h = $("#livechat_menu").height();
            let bot_select_h = 63;
            let card_footer_h = $(".card-footer").height();
            let put_content_h = window_h - livechat_menu_h - bot_select_h;
            let conversation_modal_body_h = window_h - livechat_menu_h - card_footer_h - 87 - 47;            
            $("#put_content").css("height",put_content_h);
            $("#conversation_modal_body").css("height",conversation_modal_body_h);

            let chat_options_left = $("#chat_options_left").html();
            $("#chat_options_left").html('');
            $("#chat_options_bottom").parent().removeClass('d-none');
            $("#chat_options_bottom").html(chat_options_left);

            $(".no_padding_col_right").removeClass('col-2');
            $(".no_padding_col_right").removeClass('col-md-2');
            $(".no_padding_col_right").css("width","85px");
        }
    });
</script>