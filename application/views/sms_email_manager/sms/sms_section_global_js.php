<script>
    ...
    $(document).ready(function($) {
        ...
        $(document).on('click', '#update_api', function(event) {
            ...
            var shortcode = $("#updated_shortcode").val();
        ...
        $(document).on('click','#create_campaign',function(){
            ...
            var google_contacts_id = $("#google_contacts_id").val();
            ...
            if(page_name == "" && contacts_id == "" && to_numbers == "" && google_contacts_id == "")
    ...
    // =================================================== SMS Report Section ===============================================
        ...
        // For google Contacts
        $(document).on('change', '#google_contacts_id', function(event) {
            event.preventDefault();
            var google_contacts_id = $("#google_contacts_id").val();
            $("#google_contact_numbers").html('<i class="fas fa-spinner fa-spin"></i>');
            $.ajax({
                url: base_url+'sms_email_manager/google_contacts_total_numbers',
                type: 'POST',
                data: {google_contacts_id: google_contacts_id},
                success:function(response){
                    if(response!="")
                        $("#google_contact_numbers").html(response);
                    else
                        $("#google_contact_numbers").html("0");
                }
            })
        });
