    ...
    <?php if(isset($whatsapp_unread_data) && count($whatsapp_unread_data)>0):?>
      <div class="dropdown-menu dropdown-list dropdown-menu-right">
        ...
        <div class="dropdown-list-content dropdown-list-icons">
          ...
          { ?>
            <a href="<?php echo base_url('livechat/load_livechat').'?media_type='.$row->social_media.'&subscriber_id='.$row->subscribe_id;?>" class="dropdown-item">
              <div class="dropdown-item-icon <?php echo ($row->social_media === 'fb') ? 'bg-primary' : 'bg-secondary gradient'; ?> text-white">
