...
<script type="text/javascript">
  console.log(selected_global_media_type);
                  ...
                  <div class="row">
                    ...
                    <div class="col-8 col-md-4">
                      <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>" style="display: none;">
                        ...
                        <select class="form-control push_postback" name="text_with_button_post_id_<?php echo $i; ?>" id="text_with_button_post_id_<?php echo $i; ?>">
                        ...
                        <div class="row">
                          ...
                          <div class="col-8 col-md-4">
                            <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j; ?>" style="display: none;">
                              ...
                              <select class="form-control push_postback" name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j; ?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j; ?>">
                                <option value=""><?php echo $this->lang->line("Select PostBack id"); ?></option>
                              </select>
                              <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("Add"); ?></a>
                              <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo $this->lang->line("Refresh"); ?></a>
                              ...
                              <div class="row">
                                ...
                                <div class="col-8 col-md-4">
                                  <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>" style="display: none;">
                                    ...
                                    <select class="form-control push_postback" name="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>" id="text_with_button_post_id_<?php echo $i; ?>_<?php echo $j; ?>_<?php echo $k; ?>">
                                      <option value=""><?php echo $this->lang->line("Select PostBack id"); ?></option>
                                    </select>
                                    <a href="" class="add_template float-left"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("Add"); ?></a>
                                    <a href="" class="ref_template float-right"><i class="fa fa-refresh"></i> <?php echo $this->lang->line("Refresh"); ?></a>
