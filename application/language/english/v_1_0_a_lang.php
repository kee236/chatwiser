...
$lang = array(
    ...
    "welcome_back_power_user" => "Welcome Back, Power User!",
    "access_your_automation_hub" => "Access Your Automation Hub",
    "login_to_grow_business" => "Login to Grow Your Business 24/7",
    "trusted_by_thousands_subtitle" => "Join thousands of businesses already automating their success",
    "secure_login_protected" => "Your data is secure and protected",
    "login_instant_access" => "Get instant access to your campaigns",
    "remember_secure_device" => "Remember me!",
    "forgot_password_quick" => "Forgot Password?",
    "signin_start_growing" => "Sign In & Start Growing",
    "new_to_chatwiser" => "New to chatwiser?",
    "create_free_account" => "Create Your Free Account",
    "already_growing_with_us" => "10,000+ businesses are already growing with us",
    "join_successful_businesses" => "Join successful businesses using chatwiser",
    
    // Sign Up Page - Conversion Optimized Strings
    "start_growing_today" => "Start Growing Your Business Today",
    "join_automation_revolution" => "Join the Automation Revolution",
    "free_account_no_credit" => "Create your free account - no credit card required",
    "start_automating_instantly" => "Start automating customer conversations instantly",
    "trusted_by_businesses" => "Trusted by 10,000+ businesses worldwide",
    "your_business_details" => "Your Business Details",
    "secure_account_setup" => "Secure Account Setup",
    "full_name_label" => "Full Name",
    "business_email_label" => "Business Email",
    "secure_password_label" => "Secure Password",
    "confirm_password_label" => "Confirm Password",
    "verify_human_label" => "Verify You're Human",
    "terms_privacy_agree" => "I agree to the Terms of Service and Privacy Policy",
    "create_account_start" => "Create Account & Start Growing",
    "already_member" => "Already a member?",
    "sign_in_here" => "Sign in here",
    "join_growth_community" => "Join our community of growing businesses",
    
    // Forgot Password Page - Conversion Optimized Strings
    "reset_password_quickly" => "Reset Your Password Quickly",
    "back_to_business_fast" => "Get back to growing your business in minutes",
    "secure_password_reset" => "Secure & instant password reset process",
    "enter_business_email" => "Enter your business email address",
    "email_address_label" => "Email Address",
    "send_reset_instructions" => "Send Reset Instructions",
    "check_email_shortly" => "Check your email shortly for reset instructions",
    "back_to_login_page" => "Back to Login",
    "having_trouble_email" => "Having trouble? Contact our support team",
    "Having trouble?" => "Having trouble?",
    "Contact our support team" => "Contact our support team",
    "password_reset_secure" => "Secure & instant password reset process",
    "quick_access_account" => "Quick access back to your account",
