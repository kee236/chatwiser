...
class Admin extends Home
{
    ...
    {        
	    ...
	    else
	    {
            ...
            $google_sheet_selected_value = isset($mail_service_id['google_sheet']) ? $mail_service_id['google_sheet']:"";
	    }
        ...
        $data['google_sheet_selected_value'] = $google_sheet_selected_value;
    ...
    {       
        ...
        if ($_POST) 
        {
            ...
            else 
            {
                ...
                $delete_livechat_old_message_day=addslashes(strip_tags($this->input->post('delete_livechat_old_message_day', true)));
                ...
                $app_my_config_data.= "\$config['delete_livechat_old_message_day'] = '".$delete_livechat_old_message_day."';\n";
